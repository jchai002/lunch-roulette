...
class SomethingsControllerTest < ActionController::TestCase
  ...
  test "should create something" do
    assert_difference('Something.count') do
      post :create, something: { lat: @something.lat, long: @something.long, radius: @something.radius, rating: @something.rating }
    end
  ...
  test "should update something" do
    patch :update, id: @something, something: { lat: @something.lat, long: @something.long, radius: @something.radius, rating: @something.rating }
    assert_redirected_to something_path(assigns(:something))
  end
